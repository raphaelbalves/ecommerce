let layoutCartao = document.querySelector(".cartao")
...
validaCVV.addEventListener("focusout", () => {
    ...
    if (!padraoCVV.test(validaCVV.value)) {
        ...
        layoutCartao.classList.add("animate__animated")
        layoutCartao.classList.add("animate__flipInY")
        layoutCartao.style.display = "none"
    }
})
